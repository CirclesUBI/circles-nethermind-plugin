...
public static class StaticResources
{
    ...
    public static (ImmutableHashSet<long> knownBlocks, long maxKnownBlock) GetKnownRelevantBlocks(ulong chainId)
    {
        ...
        {
            return (ImmutableHashSet<long>.Empty, -1);
        }
        ...
        using (StreamReader streamReader = new(resourceStream))
        {
            ...
            return (knownRelevantBlocks.ToImmutableHashSet(), maxKnownBlock);
        }
    }
}
