...
public abstract class BufferSink : ISnapshotSource, ISink
{
    ...
    public void AddErc1155Uri(long blockNumber, long blockTimestamp, int receiptIndex, int logIndex,
        string transactionHash, UInt256 id, string uri)
    {
        _erc1155UriData.Add(new(
            blockNumber, blockTimestamp, receiptIndex,
            logIndex, transactionHash, id, uri
        ));
    }
    
    public void AddErc1155TransferSingle(long blockNumber, long blockTimestamp, int receiptIndex, int logIndex,
        string transactionHash, string operatorAddress, string fromAddress, string toAddress, UInt256 id, UInt256 value)
    {
        _erc1155TransferSingleData.Add(new(
            blockNumber, blockTimestamp, receiptIndex,
            logIndex, transactionHash, operatorAddress, fromAddress, toAddress, id, value
        ));
    }
    
    public void AddErc1155TransferBatch(long blockNumber, long blockTimestamp, int receiptIndex, int logIndex, int batchIndex,
        string transactionHash, string operatorAddress, string fromAddress, string toAddress, UInt256 id, UInt256 value)
    {
        _erc1155TransferBatchData.Add(new(
            blockNumber, blockTimestamp, receiptIndex,
            logIndex, batchIndex, transactionHash, operatorAddress, fromAddress, toAddress, id, value
        ));
    }
    
    public void AddErc1155ApprovalForAll(long blockNumber, long blockTimestamp, int receiptIndex, int logIndex,
        string transactionHash, string ownerAddress, string operatorAddress, bool approved)
    {
        _erc1155ApprovalForAllData.Add(new(
            blockNumber, blockTimestamp, receiptIndex,
            logIndex, transactionHash, ownerAddress, operatorAddress, approved
        ));
    }
