...
public class Sink
{
    ...
    private SqliteCommand? _addErc20TransferInsertCmd;
    ...
    public void AddCirclesHubTransfer(long blockNumber, ulong timestamp, int transactionIndex, int logIndex,
        ...
        string toAddress, UInt256 amount)
    {
    ...
    public void AddErc20Transfer(
        ...
        , UInt256 value)
    {
        // PrepareAddErc20TransferInsertCommand();
        //
        // if (_transactionCounter == 0)
        // {
        //     BeginTransaction();
        // }
        //
        // _addErc20TransferInsertCmd!.Transaction = _transaction;
        // _addErc20TransferInsertCmd.Parameters["@blockNumber"].Value = blockNumber;
        // _addErc20TransferInsertCmd.Parameters["@timestamp"].Value = timestamp;
        // _addErc20TransferInsertCmd.Parameters["@transaction_index"].Value = transactionIndex;
        // _addErc20TransferInsertCmd.Parameters["@log_index"].Value = logIndex;
        // _addErc20TransferInsertCmd.Parameters["@transactionHash"].Value = transactionHash;
        // _addErc20TransferInsertCmd.Parameters["@tokenAddress"].Value = tokenAddress;
        // _addErc20TransferInsertCmd.Parameters["@fromAddress"].Value = from;
        // _addErc20TransferInsertCmd.Parameters["@toAddress"].Value = to;
        // _addErc20TransferInsertCmd.Parameters["@amount"].Value = value.ToString(CultureInfo.InvariantCulture);
        // _addErc20TransferInsertCmd.ExecuteNonQuery();
        //
        // _transactionCounter++;
    }
    ...
    public void Dispose()
    {
        ...
        _addErc20TransferInsertCmd?.Dispose();
    ...
    private void PrepareAddErc20TransferInsertCommand()
    {
        if (_addErc20TransferInsertCmd != null) return;

        _addErc20TransferInsertCmd = _connection.CreateCommand();
        _addErc20TransferInsertCmd.CommandText = @$"
            INSERT INTO {TableNames.Erc20Transfer} (block_number, timestamp, transaction_index, log_index, transaction_hash, token_address, from_address, to_address, amount)
            VALUES (@blockNumber, @timestamp, @transaction_index, @log_index, @transactionHash, @tokenAddress, @fromAddress, @toAddress, @amount);
        ";

        _addErc20TransferInsertCmd.Parameters.AddWithValue("@blockNumber", 0);
        _addErc20TransferInsertCmd.Parameters.AddWithValue("@timestamp", 0);
        _addErc20TransferInsertCmd.Parameters.AddWithValue("@transaction_index", 0);
        _addErc20TransferInsertCmd.Parameters.AddWithValue("@log_index", 0);
        _addErc20TransferInsertCmd.Parameters.AddWithValue("@transactionHash", "");
        _addErc20TransferInsertCmd.Parameters.AddWithValue("@tokenAddress", "");
        _addErc20TransferInsertCmd.Parameters.AddWithValue("@fromAddress", "");
        _addErc20TransferInsertCmd.Parameters.AddWithValue("@toAddress", "");
        _addErc20TransferInsertCmd.Parameters.AddWithValue("@amount", "");
    }
